...
public class MobiComUserPreference {
    ...
    private static String user_language = "user_language";
    private static String user_translate = "user_translate";
    ...
    public void setLanguage(Language language) {
        sharedPreferences.edit().putString(user_language, language.toString()).commit();
    }
    ...
    public boolean isUser_translate() {
        return sharedPreferences.getBoolean(user_translate, true);
    }

    public void setUser_translate(boolean isTranslate) {
        sharedPreferences.edit().putBoolean(user_translate, isTranslate).apply();
    }
