 ...
 */
package com.applozic.mobicomkit.api.translation.translate;
...
public final class Translate extends YandexTranslatorAPI {
  ...
  public static String execute(final String text, final Language from, final Language to) throws Exception {
    ...
    final String params = 
        ...
        + PARAM_LANG_PAIR + URLEncoder.encode(from.getName(),ENCODING) + URLEncoder.encode("-",ENCODING) + URLEncoder.encode(to.getName(),ENCODING)
...
//    try {
//      Translate.setKey(utils.ApiKeys.YANDEX_API_KEY);
