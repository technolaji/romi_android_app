package technolaji.romiglobal.models;
...
/**
 * Created by bolajiabiodun on 05/10/2016.
 */
...
public class User extends JsonMarker {
    ...
    private Short authenticationTypeId = com.applozic.mobicomkit.api.account.user.User.AuthenticationType.CLIENT.getValue();
