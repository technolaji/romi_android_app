            ...
            public void onClick(View v) {
                UserLogoutTask.TaskListener userLogoutTaskListener = new UserLogoutTask.TaskListener() {
                    ...
                    public void onSuccess(Context context) {
                        ...
                        Intent intent = null;
                        try {
                            intent = new Intent(getActivity(), Class.forName("technolaji.romiglobal.WelcomeActivity"));
                    ...
                    public void onFailure(Exception exception) {
                        userLogoutTask = null;
//                        AlertDialog alertDialog = new AlertDialog.Builder(getContext().cr);
...
//                        }
                ...
                userLogoutTask = new UserLogoutTask(userLogoutTaskListener, getContext());
